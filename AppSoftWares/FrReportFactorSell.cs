...
{
    public partial class FrReportFactorSell : MetroFramework.Forms.MetroForm
    {
        public FrReportFactorSell()
        {
            InitializeComponent();
        }
        ...
        private void FrReportFactorSell_Load(object sender, EventArgs e)
        {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt;
            dt = new DataTable();
            dt.TableName = "factor_sell_table";
            foreach (DataGridViewColumn col in factor_Sell_TableDataGridView.Columns)
            {
                dt.Columns.Add(col.DataPropertyName, col.ValueType);
            }
            foreach (DataGridViewRow gridRow in factor_Sell_TableDataGridView.Rows)
            {
                if (gridRow.IsNewRow)
                    continue;
                DataRow dtRow = dt.NewRow();
                for (int i1 = 0; i1 < factor_Sell_TableDataGridView.Columns.Count; i1++)
            ...
            stiReport1.Load(System.Windows.Forms.Application.StartupPath + @"\ReportSell.mrt");
        ...
        private void maskedTextBox1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    factor_Sell_TableBindingSource.DataSource = Factors.SelectLikeFactorSellD(metroTextBox1.Text, maskedTextBox1.Text);
